...
# this is the move that defines the alchemical atoms in resname LIG (everything connected to atom 8 is fully decoupled)
moves = [DihedralMove(structure, (4, 8), residue="LIG")]
