...
from openmmslicer.moves import TranslationMove, RotationMove, DihedralMove
...
# move and rotate ligand around its COM and also rotate Val111 dihedral
moves = [TranslationMove(structure, "UNL", radii=0.5 * unit.nanometer),
         RotationMove(structure, "UNL"),
         DihedralMove(structure, (1735, 1737))]
