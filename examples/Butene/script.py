...
# this is the move that defines the alchemical atoms (everything connected to atom 2 is fully decoupled)
moves = [
    DihedralMove(aligned_structures.main_structure, (1,2), movable_residue="UNL"),
]
